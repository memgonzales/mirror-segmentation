...
# VoVNet + Proposed Boundary Extraction Module
# ===================================================
...
class PMDLite(nn.Module):
    def __init__(self, training=False):
        ...
        self.m = timm.create_model('ese_vovnet39b', features_only=True, pretrained=True)
        ...
        self.contrast_4 = Contrast_Module_Deep(1024,d1=2, d2=4)
        self.contrast_3 = Contrast_Module_Deep(768,d1=4, d2=8)
        self.contrast_2 = Contrast_Module_Deep(512, d1=4, d2=8)
        self.contrast_1 = Contrast_Module_Deep(256, d1=4, d2=8)

        self.ra_4 = Relation_Attention(1024, 1024)
        self.ra_3 = Relation_Attention(768, 768)
        self.ra_2 = Relation_Attention(512, 512)
        self.ra_1 = Relation_Attention(256, 256)

        self.up_4 = nn.Sequential(nn.ConvTranspose2d(1024, 256, 4, 2, 1), nn.BatchNorm2d(256), nn.ReLU())
        self.up_3 = nn.Sequential(nn.ConvTranspose2d(768, 192, 4, 2, 1), nn.BatchNorm2d(192), nn.ReLU())
        ...
        self.cbam_3 = CBAM(192)
        self.cbam_2 = CBAM(128)
        self.cbam_1 = CBAM(64)

        self.layer4_predict = nn.Conv2d(256, 1, 3, 1, 1)
        self.layer3_predict = nn.Conv2d(192, 1, 3, 1, 1)
