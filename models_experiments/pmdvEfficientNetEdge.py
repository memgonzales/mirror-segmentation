...
# EfficientNetEdge + Proposed Boundary Extraction Module
# ===================================================
...
class PMDLite(nn.Module):
    def __init__(self, training=False):
        ...
        self.m = timm.create_model('efficientnet_el_pruned', features_only=True, pretrained=True)
        
        self.edge_extract = BFE_Module(2048)
        
        self.edge_predict = nn.Sequential(nn.Conv2d(138, 69, 1, 1, 1), nn.BatchNorm2d(69),
                                nn.ReLU(), nn.Conv2d(69, 1, 3, 1, 1))

        self.contrast_4 = Contrast_Module_Deep(232,d1=2, d2=4)
        self.contrast_3 = Contrast_Module_Deep(176,d1=4, d2=8)
        self.contrast_2 = Contrast_Module_Deep(56, d1=4, d2=8)
        self.contrast_1 = Contrast_Module_Deep(40, d1=4, d2=8)

        self.ra_4 = Relation_Attention(232, 232)
        self.ra_3 = Relation_Attention(176, 176)
        self.ra_2 = Relation_Attention(56, 56)
        self.ra_1 = Relation_Attention(40, 40)

        self.up_4 = nn.Sequential(nn.ConvTranspose2d(232, 58, 4, 2, 1), nn.BatchNorm2d(58), nn.ReLU())
        self.up_3 = nn.Sequential(nn.ConvTranspose2d(176, 44, 4, 2, 1), nn.BatchNorm2d(44), nn.ReLU())
        self.up_2 = nn.Sequential(nn.ConvTranspose2d(56, 14, 4, 2, 1), nn.BatchNorm2d(14), nn.ReLU())
        self.up_1 = nn.Sequential(nn.ConvTranspose2d(40, 10, 4, 2, 1), nn.BatchNorm2d(10), nn.ReLU())
        ...
        self.layer4_predict = nn.Conv2d(58, 1, 3, 1, 1)
        self.layer3_predict = nn.Conv2d(44, 1, 3, 1, 1)
        self.layer2_predict = nn.Conv2d(14, 1, 3, 1, 1)
        self.layer1_predict = nn.Conv2d(10, 1, 3, 1, 1)
