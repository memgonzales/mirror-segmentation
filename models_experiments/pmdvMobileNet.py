...
# MobileNet + Proposed Boundary Extraction Module
# ===================================================
...
class Relation_Attention(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.ra1 = RAttention(inter_channels + 1)
...
class BFE_Module(nn.Module):
    def __init__(self, planes):
        ...
        self.inplanes = 24
        self.inplanes_half = self.inplanes // 2
...
class PMDLite(nn.Module):
    def __init__(self, training=False):
        ...
        self.m = timm.create_model('mobilenetv3_large_100_miil_in21k', features_only=True, pretrained=True)
        
        self.edge_extract = BFE_Module(960)
        
        self.edge_predict = nn.Sequential(nn.Conv2d(288, 144, 1, 1, 1), nn.BatchNorm2d(144),
                                nn.ReLU(), nn.Conv2d(144, 1, 3, 1, 1))

        self.contrast_4 = Contrast_Module_Deep(960,d1=2, d2=4)
        self.contrast_3 = Contrast_Module_Deep(112,d1=4, d2=8)
        self.contrast_2 = Contrast_Module_Deep(40, d1=4, d2=8) 
        self.contrast_1 = Contrast_Module_Deep(24, d1=4, d2=8)

        self.ra_4 = Relation_Attention(960, 960)
        self.ra_3 = Relation_Attention(112, 112)
        self.ra_2 = Relation_Attention(40, 40)
        self.ra_1 = Relation_Attention(24, 24)

        self.up_4 = nn.Sequential(nn.ConvTranspose2d(960, 240, 4, 2, 1), nn.BatchNorm2d(240), nn.ReLU())
        self.up_3 = nn.Sequential(nn.ConvTranspose2d(112, 18, 4, 2, 1), nn.BatchNorm2d(18), nn.ReLU())
        self.up_2 = nn.Sequential(nn.ConvTranspose2d(40, 10, 4, 2, 1), nn.BatchNorm2d(10), nn.ReLU())
        self.up_1 = nn.Sequential(nn.ConvTranspose2d(24, 6, 4, 2, 1), nn.BatchNorm2d(6), nn.ReLU())

        self.cbam_4 = CBAM(240)
        self.cbam_3 = CBAM(18)
        self.cbam_2 = CBAM(10)
        self.cbam_1 = CBAM(6)

        self.layer4_predict = nn.Conv2d(240, 1, 3, 1, 1)
        self.layer3_predict = nn.Conv2d(18, 1, 3, 1, 1)
        self.layer2_predict = nn.Conv2d(10, 1, 3, 1, 1)
        self.layer1_predict = nn.Conv2d(6, 1, 3, 1, 1)
